...
# Return/Enter keysym is 0xff0d
keycode = x11.XKeysymToKeycode(display, 0xff0d)
print("Enter keycode:", keycode)
...
# Send Enter KeyPress and KeyRelease
send_key(window, keycode, True)
time.sleep(0.05)
send_key(window, keycode, False)

print("Sent Enter key to window successfully.")
